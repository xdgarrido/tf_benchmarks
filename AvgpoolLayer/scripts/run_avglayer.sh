...
starttime=$(date +%s)
# run average pool layer
output=$(python3 /tf_benchmarks/AvgpoolLayer/layer_avg.py --iter=$COUNT --precision=$PRECISION --mode=$MODE --batch_size=$BATCH  \
